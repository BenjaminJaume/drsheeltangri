...
<div class="container my-5">
    <div class="row">
        <div class="col-12 col-lg-6 text-center mx-auto mb-5 mb-lg-0">
            <h1><?php echo get_the_title($image_1['img']['id']); ?></h1>
        ...
        <div class="col-12 col-lg-6 text-center mx-auto">
            <h1><?php echo get_the_title($image_2['img']['id']); ?></h1>
            <?php echo wp_get_attachment_image($image_2['img']['id'], '', true, "class=img-fluid frame"); ?>
            <a href="<?php echo $image_2['pdf_file']['url']; ?>" alt="" class="btn btn-success rounded-0 mt-3" download>
