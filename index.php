        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="font-manrope text-danger">
                        Please provide word(s) for your search
                    </h1>
                            ...
                            <?php while (have_posts()) {
                                ...
                                if (get_post_type() != 'testimonials') { ?>
                                    <li class="list-group-item">
                                        ...
                                        <a href=" <?php the_permalink(); ?>" title="<?php the_title(); ?>" class="h1 text-primary font-manrope">
                                            <?php the_title(); ?>
                                        </a>
                                        <p>
                                            <?php the_excerpt(); ?>
                                        ...
                                        <p>
                                            <a href="<?php the_permalink(); ?>" class="btn btn-success rounded-0 hvr-icon-forward">
                                                Read More
